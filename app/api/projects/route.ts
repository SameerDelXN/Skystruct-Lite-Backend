...
//     to: toEmail,
//     subject: "Your Project Account Credentials",
//     html: `
//       <h2>Welcome, ${name}!</h2>
//       <p>Your project has been created successfully. We've also created your client account.</p>
//       <p><b>Login Credentials:</b></p>
//       <ul>
//         <li><b>Email:</b> ${toEmail}</li>
//         <li><b>Password:</b> ${password}</li>
//       </ul>
//       <p>You can now log in and track your project progress.</p>
...
//     // ✅ Step 1: Create client user (if not exists)
...
//       {
//         success: true,
//         message: "Project created successfully. Client account created & credentials emailed.",
//         data: populated,
//       },
//       { status: 201 }
//     );
